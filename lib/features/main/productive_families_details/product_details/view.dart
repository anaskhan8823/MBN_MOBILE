...
class ProductDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => ProductCubit()..getAllCommentsForProduct(productId),
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading:
                CustomBackButtonWithCircleContainer(color: pink, isEn: isEn),
          ),
            ...
            ClipRRect(
              ...
              child: Image.network(
                ...
                errorBuilder: (context, error, stackTrace) {
                  return Image.asset(AppImages.wallet);
                },
              ),
            ),
            Container(
              ...
              child: Column(
                ...
                children: [
                  CustomNameAndItsRating(
                      rating: "4.5", name: productName, color: pink),
                  Row(
                    spacing: 4,
                    children: [
                      CustomSvg(
                      ...
                      Text(recentPrice.replaceAll(".00", ""),
                  ...
                  Text(
                    description,
                    style: TextStyle(
                        color: AppColors.whiteAndGreyColor, fontSize: 14.sp),
                  ),
                  const SizedBox(height: 10),
                  ...
                  TextSeeAll(
                      ...
                      onPressed: () {
                        // AppNavigator.push(const AllProductsProductiveFamiliesView());
                      }),
                  SizedBox(
                  ...
                  const SizedBox(height: 25),
                  CommentsForProductProductiveSection(
                    color: pink,
                  ),
                ],
              ),
