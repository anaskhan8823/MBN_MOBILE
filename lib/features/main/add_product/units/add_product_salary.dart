...
class AddProductSalary extends StatelessWidget {
  const AddProductSalary({super.key, this.color});
  final Color? color;
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                CustomFieldText(
                  ...
                  isRequired: true,
                  errorText: '',
                  labelText: 'addProduct.price'.tr(),
                  iconStart: AppSvg.priceChangeRounded,
                  onChanged: (_) => cubit.calculatePriceAfterDisc(),
                ),
                CustomFieldText(
                  controller: cubit.discVal,
                  isRequired: false,
                  errorText: '',
                  labelText: 'addProduct.discValue'.tr(),
                ...
                CustomFieldText(
                  ...
                  isRequired: false,
                  errorText: '',
                  labelText: 'addProduct.afterDisc'.tr(),
                  iconStart: AppSvg.discountFill,
                  iconColor: color,
                ),
                CustomDropButton(
