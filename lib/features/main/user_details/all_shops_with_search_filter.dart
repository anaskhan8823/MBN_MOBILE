...
class AllShopsForUserWithSearchResult extends StatelessWidget {
  const AllShopsForUserWithSearchResult({super.key, required this.searchText});
  final String searchText;
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => StoreAndProductCubit()
        ..getAllStoresForUserWithFilterSearch(searchText),
      child: Scaffold(
          appBar: AuthAppbar(
            ...
            actions: [
              Padding(
                ...
                child: GestureDetector(
                    onTap: () {
                      AppNavigator.push(const CategoryView());
                    },
                    child: Icon(
                      Icons.tune,
