        ...
        Row(
          children: [
            SizedBox(
              ...
              child: SvgPicture.asset(
                ...
                colorFilter: ColorFilter.mode(
                    AppColors.primaryProductive, BlendMode.srcIn),
            ...
            CustomUserProfileImage(
              url: successLoadUserData
                  ? homeState.list.profilePicture
                  : CachHelper.image,
              color: AppColors.primaryProductive,
            ),
          ],
          ...
          children: [
            ...
            Expanded(
              child: DetailsOfUserInHome(
                ...
                number:
                    successLoadUserData ? homeState.list.order.toString() : "0",
